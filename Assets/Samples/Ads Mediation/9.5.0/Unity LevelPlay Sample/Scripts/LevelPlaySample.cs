...
public class LevelPlaySample : MonoBehaviour
{
    ...
    void EnableAds()
    {
        ...
        bannerAd.OnAdImpressionDataReady += BannerOnAdImpressionDataReadyEvent;
        ...
        interstitialAd.OnAdImpressionDataReady += InterstitialOnAdImpressionDataReadyEvent;
    }
    ...
    public void OnGUI()
    {
        ...
        if (GUI.Button(loadRewardedVideoButton, "Load Rewarded Video"))
        {
            ...
            {
                Debug.Log("[LevelPlaySample] Rewarded Video Ad is not initialized yet");
            }
        }
        ...
        if (GUI.Button(loadInterstitialButton, "Load Interstitial"))
        {
            ...
            {
                Debug.Log("[LevelPlaySample] Interstitial Ad is not initialized yet");
            }
        }
        ...
        if (GUI.Button(loadBannerButton, "Load Banner"))
        {
            ...
            {
                Debug.Log("[LevelPlaySample] Banner Ad is not initialized yet");
            }
        }
    ...
    [ContextMenu("Load Banner Ad")]
    public void LoadBannerAd()
    {
        Debug.Log("[LevelPlaySample] LoadBannerAd");
        if (bannerAd != null)
        {
            bannerAd.LoadAd();
        }
    ...
    void RewardedVideoOnAdImpressionDataReadyEvent(LevelPlayImpressionData impressionData)
    {
        Debug.Log($"[LevelPlaySample] Received RewardedVideoOnAdImpressionDataReadyEvent With ImpressionData: {impressionData}");
    }

    void InterstitialOnAdImpressionDataReadyEvent(LevelPlayImpressionData impressionData)
    {
        Debug.Log($"[LevelPlaySample] Received InterstitialOnAdImpressionDataReadyEvent With ImpressionData: {impressionData}");
    }

    void BannerOnAdImpressionDataReadyEvent(LevelPlayImpressionData impressionData)
    {
        Debug.Log($"[LevelPlaySample] Received BannerOnAdImpressionDataReadyEvent With ImpressionData: {impressionData}");
    }
